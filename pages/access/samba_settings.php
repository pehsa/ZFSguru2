...
function submit_access_samba_settings()
{
 ...
 if (@isset($_POST['samba_update_config']))
 {
  ...
  elseif ((@strlen($_POST['extraglobal-dfree command']) < 2) OR
          (@$_POST['extraglobal-dfree command'] == $dfree_script))
  ...
  if ((strlen(@$_POST['newvariable_varname']) > 0) AND 
      (strlen(@$_POST['newvariable_value']) > 0))
