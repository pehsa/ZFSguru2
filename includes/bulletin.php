...
// marks all bulletin messages as read and returns UNIX timestamp
{
 global $guru;
...
// returns integer of unread bulletin messages (created/modified > lastread)
{
 // required library
 activate_library('gurudb');
...
// returns boolean whether given bulletin is marked read
{
 global $guru;
...
// provides information about bulletin type name and colour conventions
{
 $types = array(
  'gen'        => 'general',
  'rel'        => 'release',
