...
// returns array with directory locations
{
...
// returns string containing distribution type
{
	global $guru;
...
// returns string with long name of given distribution type
{
	$distnames = array(
		'RoZ' => 'Root-on-ZFS',
		'RoR' => 'Root-on-RAM',
...
// stores begin of timer, parent is an optional container timer
{
	global $timer;
...
// returns string with timekeeper HTML code; called by layout engine
{
	global $guru, $timer;
