...
// returns boolean of run status of specified service
{
	// required library
...
// returns NULL, true or false on status of internal service autostart
{
	// required library
	activate_library( 'service' );
...
// autostart control for internal services
{
	// required library
	activate_library( 'service' );
...
// returns array of internal service data
{
	global $guru;
